    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li calss="active"><a href="<?= base_url('KP_Daftar'); ?>">Pendaftaran Praktik kerja</a></li>
      ...
      <div class="group">
        ...
        <div class="group">
         <a class="buttonU" href="" ><center> Pilih File </center> </a>
          <input id="user" type="text" class="input4" value="Scan Surat Permohonan Pengajuan PKL dari Kampus .jpg/png" readonly>
        </div>
        <div class="group">
         <a class="buttonU" href="" ><center> Pilih File </center> </a>
          <input id="user" type="text" class="input4" value="Proposal PKL sesuai Bidang Pekerjaan yang diminati.jpg/png" readonly>
        </div>
      <br>
       <label for="user" class="label">Asal Perguruan TInggi</label>
          <select class="input3">
                  <option class="opsi2" value="">Pilih Provinsi</option>
                  <option class="opsi2" value="">Pilih Provinsi</option>           
          </select> 
          <br>
          <select class="input3">
                  <option class="opsi2" value="">Pilih Kabupaten</option>
                  <option class="opsi2" value="">Pilih Kabupaten</option>           
          </select>
          <br> 
          
          <select class="input3">
                  <option class="opsi2" value="">Pilih Perguruan Tinggi</option>
                  <option class="opsi2" value="">Pilih Sekolah</option>           
          </select> 
          <br>
          <center>
        <div class="group" >
        <br >
          <a class="button" href="<?= base_url('DashboardKP'); ?>" ><center> Daftar </center> </a>
        </div>
        </center>
        <div class="hr5"></div>
      </div>
  ...
  <div class="daftar-html">
    ...
    <div class="daftar-form">
      ...
      <br>
          ...
          <input id="nama" type="text" class="input3"> 
          <br>
          <label for="nama" class="label">Nomor Induk Mahasiswa (NIM)</label>
          <input id="nama" type="text" class="input3"> 
          <br> 
          
          <label for="nama" class="label">Nilai ipk</label>
          <input id="nama" type="text" class="input3">  
          <br>
          <div class="group">
         <button class="buttonU" href="" type=""><center> Pilih File </center> </button>
         
          <input id="user" type="text" class="input4" value="Scan KTP .jpg/png" readonly>
        </div>
        <div class="group">
         <a class="buttonU" href="" ><center> Pilih File </center> </a>
          <input id="user" type="text" class="input4" value="Scan KTM .jpg/png" readonly>
        </div>
        <div class="group">
         <a class="buttonU" href="" ><center> Pilih File </center> </a>
          <input id="user" type="text" class="input4" value="Scan Transkrip Nilai .pdf" readonly>
        </div>
      </div>
        </div>
      </div>
