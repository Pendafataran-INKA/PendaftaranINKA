      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
		  ...
		  <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            ...
            <h>DATA JURUSAN PERGURUAN TINGGI</h>
            </div>
          </form>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
		   ...
		   <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a class="d-none d-sm-inline-block btn btn-slg btn-primary shadow-lg" href="<?php echo base_url()?>admin/Perguruan_Tinggi/Jurusan_Tambah">Tambah</a>
          </div>
                    ...
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Perguruan_Tinggi/Jurusan_Ubah">Ubah</button></a></center></td>
