      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <select class="form-control">
                  <option class="opsi" value="">Universitas</option>
                  <option class="opsi" value="">Provinsi</option>
				  <option class="opsi" value="">Kabupaten</option>				  
          </select> 
        </div>
		</div>
          </form>	
            <a class="d-none d-sm-inline-block btn btn-slg btn-primary shadow-lg" href="<?php echo base_url()?>admin/Perguruan_Tinggi/Perguruan_Tinggi_Tambah">Tambah</a>
          </div>
                ...
                <div class="card-body">
                  <div class="chart-area">
                    <table class="table table-bordered">
						<thead>
							<tr>
								<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Nama: activate to sort column ascending" style="width: 79px;">No</th>
						...
						<tbody>
							<tr>
								...
								<td>Jawa Timur</td>
								<td>Malang</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Perguruan_Tinggi/Perguruan_Tinggi_Ubah">Ubah</button></a></center></td>
