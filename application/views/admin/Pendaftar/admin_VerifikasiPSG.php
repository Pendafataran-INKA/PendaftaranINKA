    ...
    <div class="container-fluid">
     <form id="form_input_detail">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group row">
					...
					<div class="col-sm-4" >
                      ...
                      <div class="col-sm-4">
                      <label for="nomor">Peminatan: </label>
                        <input class="form-control" type="text" id="sekolah" name="sekolah">
                        </div>
                    </div>
          ...
          <label for="pass" class="label2"><strong>Penempatan</strong></label>
                  ...
                  <option class="opsi" value="">PKL (MAHASISWA)</option>           
                    ...
                    <div class="form-group row">
                      <div class="col-sm-4">
                        ...
                        <input class="form-control" type="text" id="tipe_sekolah" name="tipe_sekolah">
                      </div>
					  </div>
                        </form><center>
						<span class="btn">
