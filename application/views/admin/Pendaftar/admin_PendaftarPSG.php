      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="container justify-content-between mb-4">
            ...
            <a class=" btn btn-outline-primary active btn-lg" href="<?php echo base_url()?>admin/Pendaftar_Diterima/PendaftarPSG">Prakerin</a>
			<a class=" btn btn-outline-primary btn-lg" href="<?php echo base_url()?>admin/Pendaftar_Diterima/PendaftarPKL">KP</a>
          </div>
		  <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    ...
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td>2</td>
								<td>Binaan</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Pendaftar_Diterima/VerifikasiPSG">Verifikasi</button></center></a></td>
							</tr>
							<tr>
								<td>2</td>
								...
								<td>1</td>
								<td>Umum</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Pendaftar_Diterima/VerifikasiPSG">Verifikasi</button></a></center></td>
							</tr>
						</tbody>
					</table>
                  </div>
