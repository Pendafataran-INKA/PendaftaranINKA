      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <div class="container justify-content-between mb-4">
            ...
            <a class=" btn btn-outline-primary btn-lg" href="<?php echo base_url()?>admin/Periode_Kuota/KuotaPSG">Prakerin</a>
			<a class=" btn btn-outline-primary active btn-lg" href="<?php echo base_url()?>admin/Periode_Kuota/KuotaPKL">KP</a>
          </div>
          ...
          <select class="form-control">
                  <option class="opsi" value="">Jurusan</option>
				  <option class="opsi" value="">Periode</option>
                  <option class="opsi" value="">kuota</option>				  
          </select> 
        </div>
		</div>
          </form>	
          <a class="d-none d-sm-inline-block btn btn-slg btn-primary shadow-lg" href="<?php echo base_url()?>admin/Periode_Kuota/KuotaPKL_Tambah">Tambah</a>	
          </div>
                    ...
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td>1</td>
								<td>27</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Periode_Kuota/KuotaPKL_Ubah">Ubah</button></a></center></td>
