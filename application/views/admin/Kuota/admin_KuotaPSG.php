      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <div class="container justify-content-between mb-4">
            ...
            <a class=" btn btn-outline-primary active btn-lg" href="<?php echo base_url()?>admin/Periode_Kuota/KuotaPSG">Prakerin</a>
			<a class=" btn btn-outline-primary btn-lg" href="<?php echo base_url()?>admin/Periode_Kuota/KuotaPKL">KP</a>
          </div>
          ...
          <a class="d-none d-sm-inline-block btn btn-slg btn-primary shadow-lg" href="<?php echo base_url()?>admin/Periode_Kuota/KuotaPSG_Tambah">Tambah</a>	
          </div>
                    ...
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Periode_Kuota/KuotaPSG_Ubah">Ubah</button></a></center></td>
