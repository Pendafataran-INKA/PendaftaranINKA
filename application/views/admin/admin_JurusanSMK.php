                  ...
                  <div class="chart-area">
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								<td>1</td>
								<td>Administrasi Perkantoran</td>								<td><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin_Verifikasi">Ubah</button></a></td>
								<td><a  type="button" class=" btn btn-outline-danger btn-sm" href="<?php echo base_url()?>admin_Verifikasi">Hapus</button></a></td>
							</tr>
							<tr>
								<td>2</td>
								<td>Teknik Mesin</td>
								<td><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin_Verifikasi">Ubah</button></a></td>
								<td><a  type="button" class=" btn btn-outline-danger btn-sm" href="<?php echo base_url()?>admin_Verifikasi">Hapus</button></a></td>
							</tr>
						</tbody>
					</table>
