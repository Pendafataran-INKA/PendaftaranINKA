      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <select class="form-control">
                  <option class="opsi" value="">Nomor</option>
				  <option class="opsi" value="">Divisi</option>
          </select> 
        </div>
		</div>
          </form>
            <a class="d-none d-sm-inline-block btn btn-slg btn-primary shadow-lg" href="<?php echo base_url()?>admin/Dokumen_Admin/Penempatan_Tambah">Tambah</a>
          </div>
                  ...
                  <div class="chart-area">
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								<td>1</td>
								<td>Dukungan Infrastruktur Bisnis</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Dokumen_Admin/Penempatan_Ubah">Ubah</button></a></center></td>
