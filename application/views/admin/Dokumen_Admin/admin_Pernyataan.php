                ...
                <div class="card-body">
                  <div class="chart-area">
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								<td><center>Surat Pernyataan.docx</center></td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Dokumen_Admin/Pernyataan_Ubah">Ubah</button></a></center></td>
							</tr>
						</tbody>
					</table>
                  </div>
