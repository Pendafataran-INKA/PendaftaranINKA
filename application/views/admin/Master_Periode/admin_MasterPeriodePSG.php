      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <div class="container justify-content-between mb-4">
            ...
            <a class=" btn btn-outline-primary active btn-lg" href="<?php echo base_url()?>admin/Periode_Kuota/Master_PeriodePSG">Prakerin</a>
			<a class=" btn btn-outline-primary btn-lg" href="<?php echo base_url()?>admin/Periode_Kuota/Master_PeriodePKL">KP</a>
          </div>
          ...
          <select class="form-control">
                  <option class="opsi" value="">2020</option>
				  <option class="opsi" value="">2021</option>
                  			  
          </select> 
        </div>
		</div>
          </form>	
          <a class="d-none d-sm-inline-block btn btn-slg btn-primary shadow-lg" href="<?php echo base_url()?>admin/Periode_Kuota/PeriodePSG_Tambah">Tambah</a>	
          </div>
                    ...
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td>1</td>
								<td>2020</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Periode_Kuota/PeriodePSG_Ubah">Ubah</button></center></a></td>
							...
							<tr>
								...
								<td>2</td>
								<td>2020</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Periode_Kuota/PeriodePSG_Ubah">Ubah</button></a></center></td>
								<td><center><a  type="button" class=" btn btn-outline-danger btn-sm" href="#">Hapus</button></a></center></td>
							</tr>
							<tr>
								<td>3</td>
