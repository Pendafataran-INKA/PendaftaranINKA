        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
		   ...
		   <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a class="d-none d-sm-inline-block btn btn-slg btn-primary shadow-lg" href="<?php echo base_url()?>admin/Sekolah/Jurusan_Tambah">Tambah</a>
          </div>
                    ...
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Sekolah/Jurusan_Ubah">Ubah</button></a></center></td>
