      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <select class="form-control">
                  <option class="opsi" value="">Nama Sekolah</option>
				  <option class="opsi" value="">Tipe Sekolah</option>
            ...
            <a class="d-none d-sm-inline-block btn btn-slg btn-primary shadow-lg" href="<?php echo base_url()?>admin/Sekolah/Sekolah_Tambah">Tambah</a>
          </div>
                    ...
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td>Madiun</td>
								<td>Binaan</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Sekolah/Sekolah_Ubah">Ubah</button></a></center></td>
								<td><center><a  type="button" class=" btn btn-outline-danger btn-sm" href="#">Hapus</button></a></center></td>
							</tr>
							<tr>
								<td>2</td>
								<td>SMKN 2 Mojokerto</td>
								<td>Jawa Timur</td>
								<td>Mojokerto</td>
								<td>Umum</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Sekolah/Sekolah_Ubah">Ubah</button></a></center></td>
