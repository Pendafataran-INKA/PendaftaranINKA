      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <div class="container justify-content-between mb-4">
            ...
            <a class=" btn btn-outline-primary btn-lg" href="<?php echo base_url()?>admin/PSG/admin_BerkasPSG">Prakerin</a>
			<a class=" btn btn-outline-primary active btn-lg" href="<?php echo base_url()?>admin/PKL/admin_BerkasPKL">KP</a>
          </div>
                  ...
                  <div class="chart-area">
                    <table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								<td>3</td>
								<td>Bayu Aprilianto</td>
								<td>Universitas Banyuwangi</td>
								<td>JPEG/PNG</td>
								<td>PDF</td>
								<td>PDF</td>
								<td>JPEG/PNG</td>
