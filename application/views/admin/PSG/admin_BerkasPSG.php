    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Charts -->
        ...
        <div id="collapseCharts" class="collapse" aria-labelledby="headingCharts" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
            <a class="collapse-item active" href="<?php echo base_url()?>admin/PSG/admin_BerkasPSG">Berkas Pendaftar</a>
...
<!-- Nav Item - Alerts -->
        ...
        <div class="container-fluid">
		  ...
		  <div class="container justify-content-between mb-4">
            ...
            <a class=" btn btn-outline-primary active btn-lg" href="<?php echo base_url()?>admin/PSG/admin_BerkasPSG">Prakerin</a>
			<a class=" btn btn-outline-primary btn-lg" href="<?php echo base_url()?>admin/PKL/admin_BerkasPKL">KP</a>
          </div>
                    ...
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td>JPEG/PNG</td>
								<td>Binaan</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin_Verifikasi">Unduh</button></a></center></td>
							</tr>
							<tr>
								<td>2</td>
								<td>Ladeta Okta</td>
								<td>SMKN 5 Pasuruan</td>
								<td>JPEG/PNG</td>
								<td>PDF</td>
								<td>JPEG/PNG</td>
								<td>Umum</td>
