      ...
      <div id="content">
        ...
        <div class="container-fluid">
		 ...
		 <div class="container justify-content-between mb-4">
            ...
            <a class=" btn btn-outline-primary active btn-lg" href="<?php echo base_url()?>admin/PSG/admin_DiterimaPSG">Prakerin</a>
			<a class=" btn btn-outline-primary btn-lg" href="<?php echo base_url()?>admin/PKL/admin_DiterimaPKL">KP</a>
          </div>
