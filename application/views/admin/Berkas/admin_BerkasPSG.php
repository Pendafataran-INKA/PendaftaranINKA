...
<!-- Nav Item - Alerts -->
        ...
        <div class="container-fluid">
		  ...
		  <div class="container justify-content-between mb-4">
            ...
            <a class=" btn btn-outline-primary active btn-lg" href="<?php echo base_url()?>admin/Berkas_Persyaratan/BerkasPSG">Prakerin</a>
			<a class=" btn btn-outline-primary btn-lg" href="<?php echo base_url()?>admin/Berkas_Persyaratan/BerkasPKL">KP</a>
          </div>
          ...
          <select class="form-control">
				  ...
				  <option class="opsi" value="">Asal Sekolah</option>				  
          </select> 
        </div>
		</div>
          </form>
                    ...
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td>JPEG/PNG</td>
								<td>Binaan</td>
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="#">Unduh</button></a></center></td>
							</tr>
							<tr>
								<td>2</td>
								<td>Ladeta Okta</td>
