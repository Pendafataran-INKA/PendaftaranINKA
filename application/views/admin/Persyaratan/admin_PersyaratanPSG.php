        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
		   ...
		   <div class="container justify-content-between mb-4">
            ...
            <a class=" btn btn-outline-primary active btn-lg" href="<?php echo base_url()?>admin/Berkas_Persyaratan/PersyaratanPSG">Prakerin</a>
			<a class=" btn btn-outline-primary btn-lg" href="<?php echo base_url()?>admin/Berkas_Persyaratan/PersyaratanPKL">KP</a>
          </div>
          ...
          <a class="d-none d-sm-inline-block btn btn-slg btn-primary shadow-lg" href="<?php echo base_url()?>admin/Berkas_Persyaratan/PersyaratanPSG_Tambah">Tambah</a>	
          </div>
                    ...
                    <table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td><center><a  type="button" class=" btn btn-outline-primary btn-sm" href="<?php echo base_url()?>admin/Berkas_Persyaratan/PersyaratanPSG_Ubah">Ubah</button></a></center></td>
