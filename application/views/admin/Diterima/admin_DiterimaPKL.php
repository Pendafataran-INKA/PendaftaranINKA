      ...
      <div id="content">
        ...
        <div class="container-fluid">
		 ...
		 <div class="container justify-content-between mb-4">
            ...
            <a class=" btn btn-outline-primary btn-lg" href="<?php echo base_url()?>admin/Pendaftar_Diterima/DiterimaPSG">Prakerin</a>
			<a class=" btn btn-outline-primary active btn-lg" href="<?php echo base_url()?>admin/Pendaftar_Diterima/DiterimaPKL">KP</a>
          </div>
