...
<!-- Body -->
    ...
    <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Persyaratan Pendaftaran</label>
    ...
    <tbody>
      ...
      <tr>
        <td>3</td>
        <td>Nilai Raport s.d semester terakhir rata2 minimal 7</td>
      </tr>
    </tbody>
  </table>
  <div class="group">
          <label for="check"></span> </label>
        </div>
  <div class="group">
